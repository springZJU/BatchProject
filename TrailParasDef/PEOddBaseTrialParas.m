function TrialParas = PEOddBaseTrialParas(params,sound_all,lfp)
...
TrialParaName={'Std1Time','DevTime','SoundTime','StdSelect','DevSelect','StdNum','FreqBase','IntBase','DurBase',...
    'FreqDev','IntDev','DurDev','FreqDiff','IntDiff','DurDiff','CueDiff','PushTime','StrType','FsRaw'};
%% set TrialParaValues
StrType.Alignments={'Align2Std1Onset','Align2DevOnset','Align2Push'};
StrType.cue_types={'freq','int','double'};
